...
public class Constants {
	public static final String BingMapsKey = "AvsQ5ax3-I_JKBc57eAbtN1V8Ii_FhOnjcKZcemThr50rfcFm4ufHSMxUzPvWxhb";
	public static final String BingSpatialQueryKey = "Mobile";
